...
header("location:../../loginpage.php");	
		...
		||($_FILES['txtsong']['type'] == "audio/mp3"))
	{
			...
			if(file_exists("songs/".$_FILES['txtsong']['name'])){
				...
				$txtsong = basename(mysqli_real_escape_string($link,$_FILES['txtsong']['name']));
				$insert = mysqli_query($link,"INSERT INTO tblsongs(songcat,songalbum,songsinger,songdesc,songfile,songwriter) VALUES('".$txtcat."','".$txtalbum."','".$txtsinger."','".$txtdesc."','".$txtsong."','".$txtwriter."')") 
