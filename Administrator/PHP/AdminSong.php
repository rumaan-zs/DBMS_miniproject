        ...
        <div class="success"></div>
			<form id="form" method="post" name="form" enctype="multipart/form-data" action="AdminAddSong.php" target="uploadframe">	
            	...
            	<div>
					...
					$id = $_REQUEST['id'];
					$get = mysqli_query($link,"SELECT tblalbum.id,tblalbum.albumname,tblalbum.albumsinger,tblalbum.albumwriter,tblcategory.catname,tblcategory.id FROM tblalbum,tblcategory WHERE tblalbum.albumcat = tblcategory.id AND tblalbum.id ='".$id."'");
                ...
                <?php 
					...
					$sql = mysqli_query($link,"SELECT id from tblalbum where id = '$id'");
