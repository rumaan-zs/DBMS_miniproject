            	...
            	<form name="category" method="post" id="form" enctype="multipart/form-data" action="AdminUpdateAlbum.php" target="uploadframe">
                	...
                	<div>
                        ...
                        <?php 
							...
							$id = $_REQUEST['id'];
							$getAlbum = mysqli_query($link,"SELECT tblalbum.id,tblalbum.albumcat,tblcategory.id,tblcategory.catname FROm tblalbum,tblcategory WHERE tblcategory.id = tblalbum.albumcat and tblalbum.id='$id'");
						...
						?>
                        <?php 
							$getCat = mysqli_query($link,"SELECT * FROM tblcategory");
                    ...
                    <?php 
						require_once('connect.php');
						$getAlbum = mysqli_query($link,"SELECT * FROM tblalbum WHERE id = '".$id."'");
						while($rowAlbum = mysqli_fetch_array($getAlbum)){
					?>
                	<div>
