    ...
    <div class="home_content"> <!--Start Web Content-->
        <div class="banner">
          ...
          <div id="apDiv1">
         	...
         	<div id="slideshow">
   				 <div class="active">
      			  <img src="image/imgdrgn.jpg" alt="Slideshow Image 1" />
        			
   				 </div>
    
  				  <div>
      				 <img src="image/bts.jpg" alt="Slideshow Image 2" />
      				 
   				 </div>
    
   				 <div>
      				 <img src="image/bp.jpg" alt="Slideshow Image 3" />
      			
   				 </div>
    
    			<div>
       				 <img src="image/1d.jpg" alt="Slideshow Image 4" />
        ...
        <div class="vote_container"> 
        	<form id="vote" name="vote" method="post"  action="vote.php">
            	<div class="header_vote"> 
                    ...
                    <div id="message">Please Vote for you favorite song genre listed below.<a href="ShowVoteStat.php" id="link">See Statistic here!</a></div>  
                    <br />
                    <?php
					require_once('Administrator/PHP/connect.php');
					$getVote = mysqli_query($link,"SELECT * FROM tblvotes");
...
<div class="img_container"><!--Start image container-->
       ...
       <div id="class_col1">
          <img src="image/1d.jpg" height="165" width="216" id="img"/>
       </div>
       <div id="class_col2"><img src="image/bp.jpg" height="165" width="216" id="img"/></div>
       <div id="class_col3"><img src="image/imgdrgn.jpg" height="165" width="216" id="img"/></div>
       <div id="class_col4"><img src="image/bts.jpg" height="165" width="216" id="img"/></div>
...
<div class="col1"><!--Start Bottom web content-->
   	 <div class="header">
            ...
            <?php 
			require_once('Administrator/PHP/connect.php');
			$sql = mysqli_query($link,"SELECT * FROM tblalbum ORDER BY id DESC LIMIT 7");
    	...
    	<div class="header">
            ...
            <table cellpadding="0" cellspacing="0" height="230" id="table"> 
				...
				<?php 
				$getVotes = mysqli_query($link,"SELECT songfile,songpoints FROM tblsongs WHERE songpoints >=1 ORDER BY songpoints DESC LIMIT 6") or die (mysql_error());
     ...
     <div class="header">
    	...
    	<div class="header">
            ...
            <?php 
			$sql = mysqli_query($link,"SELECT tblsongs.id,tblsongs.songfile,tblalbum.albumimage,tblalbum.albumname,tblsongs.songsinger FROM tblsongs,tblalbum WHERE tblsongs.songalbum = tblalbum.id AND songcat = 'OPM' ORDER BY id DESC LIMIT 7");
			while($rowAlbum = mysqli_fetch_array($sql)){
			?>
            <div class="album_holder">
            	<div class="content_holder">
