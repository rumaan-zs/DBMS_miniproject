...
$id = $_REQUEST['id'];
$getAlbumImage = mysqli_query($link,"SELECT * FROM tblalbum WHERE id = '$id'");
...
jQuery(document).ready(function() {
	...
	var audioPlaylist = new Playlist("1", [
		<?php
		$id = $_REQUEST['id'];
		$getSong = mysqli_query($link,"SELECT songfile FROM tblsongs WHERE songalbum = '$id' LIMIT 8");
	...
	<div class="playlist_wrapper">
        	...
        	<div class="playlist_info">
				...
				$sql = mysqli_query($link,"SELECT 
									   ...
									   AND tblalbum.id = '".$id."'") or die (mysqli_error($link));
