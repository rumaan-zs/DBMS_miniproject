...
<div class="container_wrapper"><!--Start Container for the web content-->
    <div class="sidebar_menu"><!--Sidebar-->
    	<h3 class="header_1">BMEG Music</h3>
            <ul>
                ...
                $getCat= mysqli_query($link,"SELECT id,catname FROM tblcategory");
    ...
    <div class="col2"><!--Start second column-->
		...
		$line = 0;
		$page = 'Category.php';
		$dataperpage = mysqli_query($link,"SELECT * FROM tblalbum WHERE albumcat = '$id'");
        ...
        $getAlbum = mysqli_query($link,"SELECT * FROM tblalbum  WHERE albumcat = '$id' ORDER BY id LIMIT $eu,$limit");
